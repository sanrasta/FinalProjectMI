...
util.saveMatrix("Cardiac_DFT", dft_cardiac)
...
util.saveMatrix("Brain_DFT", dft_brain)
...
util.saveImage("p1_Masked_Image", p1fimage)
...
util.displayImage(p2image1)
p2fimage1 = util.post_process_image(p2image1)
util.saveImage("p2_Masked_Image_1", p2fimage1)
...
util.displayImage(p2image2)
p2fimage2 = util.post_process_image(p2image2)
util.saveImage("p2_Masked_Image_2", p2fimage2)
...
util.displayImage(p2image3)
p2fimage3 = util.post_process_image(p2image3)
util.saveImage("p2_Masked_Image_3", p2fimage3)
...
util.displayImage(p2image4)
p2fimage4 = util.post_process_image(p2image4)
util.saveImage("p2_Masked_Image_4", p2fimage4)
...
util.saveImage("p3_Masked_Image", p3fimage)
...
util.displayImage(p3image10)
p3fimage10 = util.post_process_image(p3image10)
util.saveImage("p3_Masked_Image_10%", p3fimage10)
...
util.displayImage(p3image20)
p3fimage20 = util.post_process_image(p3image20)
util.saveImage("p3_Masked_Image_20%", p3fimage20)
...
util.displayImage(p3image33)
p3fimage33 = util.post_process_image(p3image33)
util.saveImage("p3_Masked_Image_33%", p3fimage33)
...
util.displayImage(p3image75)
p3fimage75 = util.post_process_image(p3image75)
util.saveImage("p3_Masked_Image_75%", p3fimage75)
...
util.displayImage(p5image)
p5fimage = util.post_process_image(p5image)
util.saveImage("p5_Masked_Image", p5fimage)
